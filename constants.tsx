...
export const SCHEMA_MAP: Record<string, { description?: string, primaryKeys: string[], fields: string[], joins?: Record<string, string> }> = {
  ...
  "dbo.v_AI_Omnibus_Forecast_Master": {
    ...
    primaryKeys: ["BranchName", "SalesRepName", "ProductName", "TimeKey"],
    fields: ["BranchName", "SalesRepName", "ProductName", "TimeKey", "Period", "MonthlyRevenue", "MonthlyQty", "PrevMonthRev", "LastYearRevenue", "ProjectedRunRate", "Momentum", "MomentumStatus", "PerformanceStatus", "SuggestedWeeklySafetyStock", "SuggestedMonthlySafetyStock", "LastYearSameMonthQty", "QuantityRunRate", "WeeklyRevenue", "WeeklyQty"]
  },
  "dbo.v_AI_Omnibus_Comparison": {
